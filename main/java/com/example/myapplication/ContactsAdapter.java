...
public class ContactsAdapter extends RecyclerView.Adapter<ContactsAdapter.MyViewHolder> implements Filterable {
    ...
    private List<Upload2> contactListFiltered;
    ...
    public ContactsAdapter(Context context, List<Upload2> contactList, ContactsAdapterListener listener) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        final Upload2 contact = contactListFiltered.get(position);
        holder.name.setText(contact.getUserName());
        holder.phone.setText(contact.getPhone());

        Glide.with(context)
                .load(contact.getmImageUrl())
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    List<Upload2> filteredList = new ArrayList<>();
                    for (Upload2 row : contactList) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                contactListFiltered = (ArrayList<Upload2>) filterResults.values;
    ...
    public interface ContactsAdapterListener {
        void onContactSelected(Upload2 contact);
    }
}
